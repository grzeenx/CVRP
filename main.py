...
# standard
files =["E-n51-k5.txt","E-n76-k10.txt","E-n101-k8.txt"]
paths=list(map( (lambda x :  "result_"+ x),files))
for i, file in enumerate(files):
    for exp_seed in [192123, 37701, 24041, 9819034501]:
        for max_iterations in [50,150]:
            for ant_count in [50, 100, 150, 200]:
                for alpha_ant in [0,0.4,0.55, 0.8,1]:
                    for beta_ant in [0,0.4, 0.6, 0.85, 1]:
                        for rho in [0, 0.3,0.6,0.8,1]:
